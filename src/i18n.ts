...
export const translations: Record<LangCode, T> = {
  ...
  pl: {
    hero: {
      ...
      headline1: 'Jakość Ultra 8K,',
      headline2: 'Oglądaj ',
      highlight: 'UEFA Champions League',
      end: 'Na żywo teraz!',
      stat1v: '89K', stat1l: 'Kanałów',
      stat2v: '200K', stat2l: 'VOD',
      stat3v: '8K', stat3l: 'Ultra HD',
      cta1: 'Wybierz plan',
      cta2: 'Natychmiastowy dostęp',
    },
    nav: {
    ...
    pricing: {
      statChannels: 'KANAŁÓW',
      statVod: 'SERIALE I FILMY',
      statUpdate: 'STAŁE AKTUALIZACJE',
      subtitle: 'Subskrypcje Premium',
      heading: 'Wybierz swój',
      highlight: 'Plan Premium.',
      desc: 'Bez automatycznego odnawiania. Bez umów. Bezpieczny, szybki i dostępny w całej Europie.',
      device1: 'Urządzenie',
      device2: 'Urządzenia',
      month1: 'Miesiąc',
      monthMany: 'Miesięcy',
      ...
      waMsg: (m, d, p) => `Cześć, chcę zamówić plan MY 8KTV: ${m} miesięcy / ${d === 1 ? '1 urządzenie' : '2 urządzenia'} / ${p} EUR`,
      trust: [
        '100% zwrotu pieniędzy', 'Pełny zwrot w ciągu 24 godzin.',
        'Natychmiastowa aktywacja', 'Dane logowania w minutach przez WhatsApp.',
        'Wsparcie WhatsApp', '24/7 bezpośrednie wsparcie przez WhatsApp.',
      ],
    },
    testimonials: {
      ...
      desc: 'Od Hiszpanii po Niemcy, od Francji po Włochy — tysiące klientów zastąpiło kablówkę usługą MY 8KTV.',
      rate: 'Średni wskaźnik odnawiania wynosi 94,2%',
    },
    devices: { heading: 'Kompatybilny z', italic: 'wszystkimi urządzeniami.', cta: 'Zacznij teraz' },
    payments: {
      subtitle: 'Zweryfikowane metody płatności',
      heading: 'Bezpieczne i zaufane',
      italic: 'metody płatności.',
      desc: 'Używamy szyfrowania bankowego (SSL i AES-256) dla wszystkich transakcji.',
      direct: 'Natychmiast',
      days12: '1—2 dni',
      methodDescs: ['Autoryzowana ochrona kupującego', 'Zabezpieczone SSL i 3D-Secure', 'Zabezpieczone SSL i 3D-Secure', 'Polecenie zapłaty z IBAN', 'Płatność bezpośrednio przez bank', 'Faktura i płatność ratalna'],
      pci: 'Wszystkie transakcje chronione certyfikatami PCI-DSS.',
    },
    faq: {
      subtitle: 'Często zadawane pytania',
      heading: 'Pytania i odpowiedzi',
      italic: 'szybko rozwiązane.',
      supportNote: 'Potrzebujesz pomocy z konfiguracją?',
      supportDesc: 'Nasz zespół wsparcia pomoże z urządzeniami MAG, Smart TV, Fire Stick lub aplikacjami IPTV.',
      supportCta: 'Skontaktuj się z pomocą',
      items: [
        { q: 'Czy jest natychmiastowa konfiguracja po zakupie?', a: 'Tak! Po potwierdzeniu płatności nasz system generuje dane logowania i wysyła pełny przewodnik przez WhatsApp w ciągu 2–5 minut.' },
        { q: 'Jakie urządzenia i aplikacje są obsługiwane?', a: 'MY 8KTV działa na praktycznie każdym urządzeniu: Smart TV (Samsung, LG, Sony, Philips), dekodery Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, dekodery MAG, Formuler i aplikacje jak IPTV Smarters, Tivimate, GSE.' },
        { q: 'Jak szybkie musi być łącze internetowe?', a: 'Dla SD co najmniej 8 Mbit/s. Dla Full HD stabilne 15 Mbit/s, dla 8K UHD 25 Mbit/s lub więcej.' },
        { q: 'Czy mogę używać subskrypcji na wielu urządzeniach jednocześnie?', a: 'Plany na 1 urządzenie: 1 strumień. 2 urządzenia: dwa ekrany jednocześnie. Plan 12-miesięczny zawiera darmowe miesiące bonusowe.' },
        { q: 'Czy są umowy lub ukryte opłaty?', a: 'Żadnych. Brak umów, opłat konfiguracyjnych i automatycznego odnawiania. Płacisz raz i odnawiasz ręcznie.' },
      ],
    },
    footer: {
      tagline: 'Premium IPTV dla całej Europy. Ponad 89 000 kanałów, 200 000+ tytułów VOD, zero umów.',
      copyright: 'Copyright © 2026 MY 8KTV. Wszelkie prawa zastrzeżone.',
      sub1: 'Subskrypcje', sub2: 'Treści i wsparcie', sub3: 'Status serwera',
      link1: 'Pakiet Starter (3 miesiące)', link2: 'Pakiet Standard (6 miesięcy)', link3: 'Plan Premium (12 miesięcy — 54% zniżki)',
      link4: 'Biblioteka VOD filmów i seriali', link5: 'Przegląd kanałów Live TV', link6: 'Konfiguracja urządzenia i FAQ',
      serverStatus: 'Status serwera', allRelays: 'Wszystkie przekaźniki aktywne',
      legal: 'MY 8KTV działa całkowicie niezależnie. Wszystkie wymienione znaki towarowe są własnością ich właścicieli. Wszystkie płatności są szyfrowane SSL.',
      cert: 'Certyfikat bezpieczeństwa', sla: 'Umowa SLA',
    },
  },
  ...
  pt: {
    ...
    pricing: {
      statChannels: 'CANAIS',
      statVod: 'SÉRIES E FILMES',
      statUpdate: 'ATUALIZAÇÃO PERMANENTE',
  ...
  ro: {
    ...
    pricing: {
      statChannels: 'CANALE',
      statVod: 'SERIALE ȘI FILME',
      statUpdate: 'ACTUALIZARE PERMANENTĂ',
      subtitle: 'Abonamente Premium',
      heading: 'Alege-ți',
      highlight: 'Planul Premium.',
      desc: 'Fără reînnoire automată. Fără contracte. Sigur, rapid și disponibil în toată Europa.',
      device1: 'Dispozitiv',
      device2: 'Dispozitive',
      month1: 'Lună',
      monthMany: 'Luni',
      ...
      cta: 'Comandă prin WhatsApp',
      waMsg: (m, d, p) => `Bună, doresc să comand planul MY 8KTV: ${m} luni / ${d === 1 ? '1 dispozitiv' : '2 dispozitive'} / ${p} EUR`,
      trust: [
        'Rambursare 100%', 'Rambursare completă în 24 de ore.',
        'Activare instantă', 'Credențiale în câteva minute prin WhatsApp.',
        'Suport WhatsApp', 'Suport direct 24/7 prin WhatsApp.',
      ],
    },
    testimonials: {
      subtitle: 'Recenzii clienți',
      heading: 'Încrederea a',
      italic: 'peste 45.000 de abonați în Europa.',
      desc: 'Din Spania în Germania, din Franța în Italia — mii de clienți și-au înlocuit abonamentul TV cu MY 8KTV.',
      rate: 'Rată medie de reînnoire de 94,2%',
    },
    devices: { heading: 'Compatibil cu', italic: 'toate dispozitivele.', cta: 'Începe acum' },
    payments: {
      subtitle: 'Metode de plată verificate',
      heading: 'Metode de plată',
      italic: 'sigure și de încredere.',
      desc: 'Folosim criptare bancară (SSL și AES-256) pentru toate tranzacțiile.',
      direct: 'Instant',
      days12: '1—2 zile',
      methodDescs: ['Protecție autorizată a cumpărătorului', 'Protejat SSL și 3D-Secure', 'Protejat SSL și 3D-Secure', 'Debit direct cu IBAN', 'Plată directă prin banca ta', 'Factură și plată în rate'],
      pci: 'Toate tranzacțiile sunt protejate de certificate de securitate PCI-DSS.',
    },
    faq: {
      subtitle: 'Întrebări frecvente',
      heading: 'Întrebări și răspunsuri',
      italic: 'rezolvate instant.',
      supportNote: 'Ai nevoie de ajutor cu configurarea?',
      supportDesc: 'Echipa noastră de suport este gata să te ajute cu boxe MAG, Smart TV, Fire Stick sau aplicații IPTV.',
      supportCta: 'Contactează suportul',
      items: [
        { q: 'Există configurare instantă după achiziție?', a: 'Da! Odată confirmată plata, sistemul generează credențialele și trimite un ghid complet prin WhatsApp în 2–5 minute.' },
        { q: 'Ce dispozitive și aplicații sunt suportate?', a: 'MY 8KTV funcționează pe aproape orice dispozitiv: Smart TV (Samsung, LG, Sony, Philips), boxe Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, boxe MAG, Formuler și aplicații precum IPTV Smarters, Tivimate, GSE.' },
        { q: 'Cât de rapidă trebuie să fie conexiunea la internet?', a: 'Pentru SD cel puțin 8 Mbit/s. Pentru Full HD 15 Mbit/s stabili, pentru 8K UHD 25 Mbit/s sau mai mult.' },
        { q: 'Pot folosi abonamentul pe mai multe dispozitive simultan?', a: 'Planuri de 1 dispozitiv: 1 stream simultan. 2 dispozitive: două ecrane simultan. Planul de 12 luni include luni bonus gratuite.' },
        { q: 'Există contracte sau taxe ascunse?', a: 'Niciunul. Fără contracte, fără taxe de configurare și fără reînnoire automată. Plătești o dată și reînnoiești manual.' },
      ],
    },
    footer: {
      tagline: 'IPTV Premium pentru toată Europa. 89.000+ canale, 200.000+ titluri VOD, fără contracte.',
      copyright: 'Copyright © 2026 MY 8KTV. Toate drepturile rezervate.',
      sub1: 'Abonamente', sub2: 'Conținut și suport', sub3: 'Starea serverului',
      link1: 'Pachet Starter (3 luni)', link2: 'Pachet Standard (6 luni)', link3: 'Plan Premium (12 luni — 54% reducere)',
      link4: 'Bibliotecă VOD filme și seriale', link5: 'Prezentare generală canale Live TV', link6: 'Configurare dispozitive și FAQ',
      serverStatus: 'Starea serverului', allRelays: 'Toate releele active',
      legal: 'MY 8KTV operează complet independent. Toate mărcile menționate sunt proprietatea proprietarilor respectivi. Toate plățile sunt criptate SSL.',
  ...
  cs: {
    hero: {
      subtitle: '#1 Premium IPTV v Evropě',
    ...
    platforms: {
      ...
      headingItalic: 'Jedno předplatné.',
      subheading: 'Netflix · Prime · Disney+ · HBO · Sky · Canal+ · Viaplay · DAZN — vše přes nás.',
      cta: 'Vybrat plán',
    },
    pricing: {
      statChannels: 'KANÁLŮ',
      ...
      subtitle: 'Prémiová předplatná',
      heading: 'Vyberte svůj',
      highlight: 'Prémiový plán.',
      desc: 'Bez automatického obnovení. Bez smluv. Bezpečné, rychlé a dostupné po celé Evropě.',
      device1: 'Zařízení',
      device2: 'Zařízení',
      month1: 'Měsíc',
      monthMany: 'Měsíců',
      ...
      cta: 'Objednat přes WhatsApp',
      waMsg: (m, d, p) => `Dobrý den, rád bych objednal plán MY 8KTV: ${m} měsíců / ${d === 1 ? '1 zařízení' : '2 zařízení'} / ${p} EUR`,
      trust: [
        '100% vrácení peněz', 'Plné vrácení do 24 hodin.',
        'Okamžitá aktivace', 'Přihlašovací údaje za minuty přes WhatsApp.',
        'Podpora WhatsApp', 'Přímá podpora 24/7 přes WhatsApp.',
      ],
    },
    testimonials: {
      subtitle: 'Recenze zákazníků',
      heading: 'Důvěřuje nám',
      italic: 'přes 45 000 odběratelů v Evropě.',
      desc: 'Od Španělska po Německo, od Francie po Itálii — tisíce zákazníků nahradily kabelovou televizi službou MY 8KTV.',
      rate: 'Průměrná míra obnovení předplatného 94,2 %',
    },
    devices: { heading: 'Kompatibilní s', italic: 'všemi zařízeními.', cta: 'Začít nyní' },
    payments: {
      subtitle: 'Ověřené platební metody',
      heading: 'Bezpečné a důvěryhodné',
      italic: 'platební metody.',
      desc: 'Pro všechny transakce používáme šifrování na bankovní úrovni (SSL a AES-256).',
      direct: 'Okamžitě',
      days12: '1—2 dny',
      methodDescs: ['Autorizovaná ochrana kupujícího', 'Chráněno SSL a 3D-Secure', 'Chráněno SSL a 3D-Secure', 'Inkaso s IBAN', 'Platba přímo přes vaši banku', 'Faktura a splátkový plán'],
      pci: 'Všechny platební transakce jsou chráněny bezpečnostními certifikáty PCI-DSS.',
    },
    faq: {
      subtitle: 'Časté dotazy',
      heading: 'Otázky a odpovědi',
      italic: 'vyřešeny okamžitě.',
      supportNote: 'Potřebujete pomoc s nastavením?',
      supportDesc: 'Náš tým podpory je připraven pomoci s MAG boxy, Smart TV, Fire Stick nebo IPTV aplikacemi.',
      supportCta: 'Kontaktovat podporu',
      items: [
        { q: 'Je po nákupu okamžité nastavení?', a: 'Ano! Jakmile je potvrzena vaše platba, náš systém vygeneruje přihlašovací údaje a pošle vám kompletního průvodce přes WhatsApp do 2–5 minut.' },
        { q: 'Jaká zařízení a aplikace jsou podporovány?', a: 'MY 8KTV funguje prakticky na jakémkoli zařízení: Smart TV (Samsung, LG, Sony, Philips), Android boxy, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG boxy, Formuler a aplikace jako IPTV Smarters, Tivimate, GSE.' },
        { q: 'Jak rychlé musí být internetové připojení?', a: 'Pro SD alespoň 8 Mbit/s. Pro Full HD stabilních 15 Mbit/s, pro 8K UHD 25 Mbit/s nebo více.' },
        { q: 'Mohu předplatné používat na více zařízeních současně?', a: 'Plány pro 1 zařízení: 1 simultánní stream. 2 zařízení: dva displeje současně. Plán na 12 měsíců zahrnuje bezplatné bonusové měsíce.' },
        { q: 'Jsou zde smlouvy nebo skryté poplatky?', a: 'Žádné. Žádné smlouvy, žádné poplatky za nastavení a žádné automatické obnovení. Zaplatíte jednou a obnovíte ručně.' },
      ],
    },
    footer: {
      ...
      sub1: 'Předplatná', sub2: 'Obsah a podpora', sub3: 'Stav serveru',
      link1: 'Startovací balíček (3 měsíce)', link2: 'Standardní balíček (6 měsíců)', link3: 'Prémiový plán (12 měsíců — 54% sleva)',
      link4: 'VOD knihovna filmů a seriálů', link5: 'Přehled živých TV kanálů', link6: 'Nastavení zařízení a FAQ',
      serverStatus: 'Stav serveru', allRelays: 'Všechny reléové stanice živě',
      legal: 'MY 8KTV funguje zcela nezávisle. Všechny zmíněné ochranné známky jsou majetkem příslušných vlastníků. Všechny platby jsou šifrovány SSL.',
  ...
  tr: {
    hero: {
      ...
      headline2: 'İzle ',
      highlight: 'UEFA Şampiyonlar Ligi',
      end: 'Şimdi Canlı!',
    ...
    pricing: {
      ...
      statUpdate: 'SÜREKLİ GÜNCELLEME',
      subtitle: 'Premium Abonelikler',
      heading: 'Senin için',
      highlight: 'Premium Planı Seç.',
      desc: 'Otomatik yenileme yok. Sözleşme yok. Güvenli, hızlı ve tüm Avrupa\'da kullanılabilir.',
      device1: 'Cihaz',
      device2: 'Cihaz',
      month1: 'Ay',
      monthMany: 'Ay',
      ...
      waMsg: (m, d, p) => `Merhaba, MY 8KTV planını sipariş etmek istiyorum: ${m} ay / ${d === 1 ? '1 cihaz' : '2 cihaz'} / ${p} EUR`,
      trust: [
        '%100 Para iadesi', '24 saat içinde tam geri ödeme.',
        'Anında aktivasyon', 'WhatsApp ile dakikalar içinde giriş bilgileri.',
        'WhatsApp desteği', '7/24 doğrudan WhatsApp desteği.',
      ],
    },
    testimonials: {
      ...
      desc: 'İspanya\'dan Almanya\'ya, Fransa\'dan İtalya\'ya — binlerce Avrupalı müşteri kablo aboneliğini MY 8KTV ile değiştirdi.',
      rate: 'Ortalama abonelik yenileme oranı %94,2',
    },
    devices: { heading: 'Tüm cihazlarla', italic: 'uyumlu.', cta: 'Şimdi başla' },
    payments: {
      subtitle: 'Doğrulanmış ödeme yöntemleri',
      heading: 'Güvenli ve güvenilir',
      italic: 'ödeme yöntemleri.',
      desc: 'Tüm işlemler için banka düzeyinde şifreleme (SSL ve AES-256) kullanıyoruz.',
      direct: 'Anında',
      days12: '1—2 gün',
      methodDescs: ['Yetkili alıcı koruması', 'SSL ve 3D-Secure korumalı', 'SSL ve 3D-Secure korumalı', 'IBAN ile otomatik ödeme', 'Bankanız üzerinden doğrudan ödeme', 'Fatura ve taksitli ödeme'],
      pci: 'Tüm ödeme işlemleri PCI-DSS güvenlik sertifikaları ile korunmaktadır.',
    },
    faq: {
      ...
      supportCta: 'Desteğe ulaş',
      items: [
        { q: 'Satın alma sonrası anında kurulum var mı?', a: 'Evet! Ödemeniz onaylandıktan sonra sistemimiz giriş bilgilerini oluşturur ve 2–5 dakika içinde WhatsApp üzerinden eksiksiz kurulum kılavuzunu gönderir.' },
        { q: 'Hangi cihazlar ve uygulamalar destekleniyor?', a: 'MY 8KTV hemen hemen her cihazda çalışır: Smart TV (Samsung, LG, Sony, Philips), Android kutular, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG kutular, Formuler ve IPTV Smarters, Tivimate, GSE gibi uygulamalar.' },
        { q: 'İnternet bağlantım ne kadar hızlı olmalı?', a: 'SD kalite için en az 8 Mbit/s. Full HD için kararlı 15 Mbit/s, 8K UHD için 25 Mbit/s veya daha fazlası.' },
        { q: 'Aboneliği aynı anda birden fazla cihazda kullanabilir miyim?', a: '1 cihazlı planlar: 1 eş zamanlı yayın. 2 cihazlı plan: iki ekranda aynı anda yayın. 12 aylık plan ücretsiz bonus aylar içerir.' },
        { q: 'Sözleşme veya gizli ücret var mı?', a: 'Hiçbiri. Sözleşme yok, kurulum ücreti yok, otomatik yenileme yok. Seçilen süre için bir kez ödeyip manuel olarak yenilersiniz.' },
      ],
    },
    footer: {
      tagline: 'Tüm Avrupa için Premium IPTV. 89.000+ kanal, 200.000+ VOD başlığı, sıfır sözleşme.',
      copyright: 'Telif Hakkı © 2026 MY 8KTV. Tüm hakları saklıdır.',
      sub1: 'Abonelikler', sub2: 'İçerik ve Destek', sub3: 'Sunucu Durumu',
      link1: 'Başlangıç Paketi (3 ay)', link2: 'Standart Paket (6 ay)', link3: 'Premium Plan (12 ay — %54 indirim)',
      ...
      legal: 'MY 8KTV tamamen bağımsız olarak faaliyet göstermektedir. Belirtilen tüm marka adları ilgili sahiplerine aittir. Tüm ödemeler tamamen SSL ile şifrelenmektedir.',
      cert: 'Güvenlik Sertifikası', sla: 'SLA Anlaşması',
    },
  },
